...
#fft low_res specific
mass_calc=True
bins=False
return_borders=False

#fft high_res specific
packing=True
mass_shift=True
...
def read_formulas(form,charge=charge,elements=elements): #either a single string or a DataFrame with element columns
